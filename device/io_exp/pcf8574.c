...
#define IIC_Init() i2c_init(2)
#define IIC_Start() i2c_start(2)
#define IIC_Stop() i2c_stop(2)
#define IIC_Send_Byte(x) i2c_send(2,x)
#define IIC_Read_Byte(x) i2c_read(2,x)
#define IIC_Wait_Ack() i2c_wait_ack(2)
#define IIC_Ack() i2c_ack(2)
#define IIC_NAck() i2c_nack(2)
