...
typedef struct gb2312_unicode
{
	unsigned short gb2312;
	unsigned short unicode;
} GB2312_UNICODE;

const GB2312_UNICODE code_table[] =
{
	{ 0xA1A1, 0x3000 },
	{ 0xA1A2, 0x3001 },
	{ 0xA1A3, 0x3002 },
...
int code_table_len = sizeof(code_table)/sizeof(GB2312_UNICODE);
...
u16 GetUnicode(u16 gb2312){
	...
	while(first <= end){
		mid = (first + end) / 2;
		if (code_table[mid].gb2312 == gb2312){
			return code_table[mid].unicode;
		}
		if(code_table[mid].gb2312 > gb2312){
			end = mid - 1;
		}else{
