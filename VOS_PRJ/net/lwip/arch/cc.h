...
#define SYS_ARCH_PROTECT(lev)		irq_save = __vos_irq_save()//lev = OS_CPU_SR_Save() 	//UCOS II中进入临界区,关中断
#define SYS_ARCH_UNPROTECT(lev)		__vos_irq_restore(irq_save)//OS_CPU_SR_Restore(lev)	//UCOS II中退出A临界区，开中断
#endif
